...
<html lang="en">
  ...
  <li class="breadcrumb-item"><a href="../">Home</a></li>
    <li class="breadcrumb-item" aria-current="page">Faculty of Sciences and Technology</li>
  </ol>
</nav>
    <br>
  <h1 class="text-center">Speciality</h1>
  <br>
  <div class="row">
    <div class="col-sm-6 mb-3 mb-sm-0">
        <div class="card">
            <img src="../images/informatic.jpg" class="card-img-top" alt="...">
            <div class="card-body">
             <h5 class="card-title">Informatics</h5>
             <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
             <a href="informatics" class="btn btn-success">Check here</a>
            </div>
        </div>
    </div>
   <div class="col-sm-6">
    <div class="card" aria-hidden="true">
        <img src="../images/comingsoon.webp" class="card-img-top" alt="...">
        <div class="card-body">
            ...
            <a href="#" tabindex="-1" class="btn btn-success disabled placeholder col-6"></a>
        </div>
    </div>
   </div>
  </div> 
