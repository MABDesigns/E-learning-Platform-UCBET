...
<html lang="en">
  ...
  <ol class="breadcrumb">
    ...
    <li class="breadcrumb-item" aria-current="page">Master 1</li>
  </ol>
</nav>
  <h1 class="text-center">Semestre</h1>
  <ul class="list-group list-group-flush">
    <li class="list-group-item">
      <a class="text-decoration-none text-primary" href="semestre1" style="color:white !important">Semestre 1</a>
    </li>
    <li class="list-group-item">
      <a class="text-decoration-none text-primary" href="#" style="color:white !important">Semestre 2</a>
    </li>
  </ul>
</div>
